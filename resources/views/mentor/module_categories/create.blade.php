...
@section('title', 'Tambah Kategori Modul')

@section('content')
    <h2 class="text-3xl font-semibold text-gray-800">Tambah Kategori Modul Baru</h2>

    <div class="mt-4 bg-white p-6 rounded shadow">
        <form action="{{ route('mentor.module-categories.store') }}" method="POST">
            @csrf
            <div class="mb-4">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('mentor.module-categories.index') }}" class="inline-block align-baseline font-bold text-sm text-blue-600 hover:text-blue-800">
                    Batal
                </a>
            </div>
        </form>
