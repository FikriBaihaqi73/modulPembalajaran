    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="bg-white p-6 rounded shadow mb-6">
            ...
            <div class="mb-4">
                ...
                <p class="mt-1 text-gray-800">{{ $announcement->major->name ?? 'N/A' }}</p>
            </div>
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <a href="{{ route('mentor.announcements.edit', $announcement->id) }}" class="bg-yellow-600 text-white px-4 py-2 rounded">
                    Edit Pengumuman
                </a>
                ...
                <a href="{{ route('mentor.announcements.index') }}" class="ml-2 text-gray-600 px-4 py-2 rounded border">
                    Kembali ke Daftar
                </a>
            </div>
        </div>
