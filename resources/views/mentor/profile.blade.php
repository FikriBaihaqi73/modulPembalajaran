...
@section('content')
    <div class="mb-8">
        <h2 class="text-3xl font-bold text-gray-900">Profil Mentor</h2>
        <p class="mt-1 text-gray-600">Kelola informasi profil dan pengaturan akun mentor Anda</p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white overflow-hidden shadow-md rounded-lg border border-gray-200">
            <div class="px-4 py-5 sm:px-6 border-b border-gray-200 bg-gray-50">
                <h3 class="text-lg font-medium text-gray-900">Informasi Mentor</h3>
                <p class="mt-1 text-sm text-gray-500">Detail informasi akun dan profil Anda.</p>
            </div>
                ...
                <div>
                    ...
                    <dl class="space-y-4">
                        ...
                        <div class="flex justify-between">
                            ...
                            <dd class="text-sm text-gray-900">Mentor</dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="text-sm font-medium text-gray-500">Jurusan:</dt>
                            <dd class="text-sm text-gray-900">{{ Auth::user()->major->name ?? 'N/A' }}</dd>
                        </div>
                    </dl>
                </div>
            </div>
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-white overflow-hidden shadow-md rounded-lg border border-gray-200">
                ...
                <div class="px-4 py-5 sm:p-6">
                    <form action="{{ route('mentor.profile.updateDetails') }}" method="POST" class="space-y-6">
                        @csrf
                        <div>
            ...
            <div class="bg-white overflow-hidden shadow-md rounded-lg border border-gray-200">
                ...
                <div class="px-4 py-5 sm:p-6">
                    <form action="{{ route('mentor.profile.updatePassword') }}" method="POST" class="space-y-6">
                        @csrf
                        <div>
