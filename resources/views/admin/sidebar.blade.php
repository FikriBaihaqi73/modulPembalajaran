<div id="sidebar" class="fixed z-30 inset-y-0 left-0 bg-gradient-to-b from-blue-800 to-indigo-900 overflow-y-auto transform transition-all duration-300 ease-in-out lg:static lg:inset-auto lg:translate-x-0 w-64 lg:w-20 lg:hover:w-64 sidebar-expanded-width">
    <div class="flex items-center justify-between px-6 py-4 border-b border-blue-700">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center pl-2.5 text-white">
            <span class="self-center text-xl font-semibold whitespace-nowrap overflow-hidden group-[.sidebar-collapsed-text]:opacity-0 transition-opacity duration-300">Admin Panel</span>
        </a>
    ...
    <nav class="mt-6 px-4">
        <a class="flex items-center py-3 px-4 rounded-lg text-gray-100 hover:bg-blue-700 hover:bg-opacity-50 hover:text-white group mb-3 transition-all {{ request()->is('/') ? 'bg-blue-700 bg-opacity-50 text-white' : '' }}" href="{{ url('/') }}">
        ...
        <a class="flex items-center py-3 px-4 rounded-lg text-gray-100 hover:bg-blue-700 hover:bg-opacity-50 hover:text-white group mb-3 transition-all {{ request()->routeIs('admin.dashboard') ? 'bg-blue-700 bg-opacity-50 text-white' : '' }}" href="{{ url('/admin/dashboard') }}">
            <svg class="h-5 w-5 flex-shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="flex items-center py-3 px-4 rounded-lg text-gray-100 hover:bg-blue-700 hover:bg-opacity-50 hover:text-white group mb-3 transition-all {{ request()->routeIs('admin.majors.*') ? 'bg-blue-700 bg-opacity-50 text-white' : '' }}" href="{{ route('admin.majors.index') }}">
            <i class="fas fa-graduation-cap flex-shrink-0 w-5 h-5 transition duration-75 group-hover:text-white {{ request()->routeIs('admin.majors.*') ? 'text-white' : '' }}"></i>
            <span class="mx-3 text-sm font-medium transition-opacity duration-300 opacity-100 whitespace-nowrap overflow-hidden group-[.sidebar-collapsed-text]:opacity-0">Manajemen Jurusan</span>
        </a>
        <a class="flex items-center py-3 px-4 rounded-lg text-gray-100 hover:bg-blue-700 hover:bg-opacity-50 hover:text-white group mb-3 transition-all {{ request()->routeIs('admin.users.*') ? 'bg-blue-700 bg-opacity-50 text-white' : '' }}" href="{{ route('admin.users.index') }}">
            <i class="fas fa-users flex-shrink-0 w-5 h-5 transition duration-75 group-hover:text-white {{ request()->routeIs('admin.users.*') ? 'text-white' : '' }}"></i>
            <span class="mx-3 text-sm font-medium transition-opacity duration-300 opacity-100 whitespace-nowrap overflow-hidden group-[.sidebar-collapsed-text]:opacity-0">Manajemen Pengguna</span>
        </a>
        <a class="flex items-center py-3 px-4 rounded-lg text-gray-100 hover:bg-blue-700 hover:bg-opacity-50 hover:text-white group mb-3 transition-all {{ request()->routeIs('admin.santri') ? 'bg-blue-700 bg-opacity-50 text-white' : '' }}" href="{{ url('/admin/santri') }}">
            <svg class="h-5 w-5 flex-shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="flex items-center py-3 px-4 rounded-lg text-gray-100 hover:bg-blue-700 hover:bg-opacity-50 hover:text-white group mb-3 transition-all {{ request()->routeIs('admin.mentor') ? 'bg-blue-700 bg-opacity-50 text-white' : '' }}" href="{{ url('/admin/mentor') }}">
            <svg class="h-5 w-5 flex-shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M17 21H7C4.79 21 3 19.21 3 17V7C3 4.79 4.79 3 7 3H17C19.21 3 21 4.79 21 7V17C21 19.21 19.21 21 17 21Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M12 11C13.6569 11 15 9.65685 15 8C15 6.34315 13.6569 5 12 5C10.3431 5 9 6.34315 9 8C9 9.65685 10.3431 11 12 11Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M12 14C8.68629 14 6 16.6863 6 20H18C18 16.6863 15.3137 14 12 14Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
        ...
        <a class="flex items-center py-3 px-4 rounded-lg text-gray-100 hover:bg-blue-700 hover:bg-opacity-50 hover:text-white group mb-3 transition-all {{ request()->routeIs('admin.modules.*') ? 'bg-blue-700 bg-opacity-50 text-white' : '' }}" href="{{ url('/admin/modules') }}">
            <svg class="h-5 w-5 flex-shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
