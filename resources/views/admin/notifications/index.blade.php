                                    ...
                                    <div class="flex justify-between items-start">
                                        <div>
                                            @if ($notification->type === 'App\\Notifications\\ReviewReplied')
                                                ...
                                                <p class="text-gray-700 text-sm mt-1">Ulasan pada modul <a href="{{ $notification->data['link'] }}" class="text-blue-600 hover:underline font-medium">{{ $notification->data['module_name'] }}</a> telah dibalas oleh {{ $notification->data['replier_name'] ?? 'Sistem' }}.</p>
                                            @elseif ($notification->type === 'App\\Notifications\\NewAnnouncement')
                                                ...
                                                <p class="text-gray-700 text-sm mt-1">{{ $notification->data['message'] ?? 'Ada pengumuman baru.' }}</p>
                                        ...
                                        <div class="flex items-center space-x-2">
                                            ...
                                            @else
                                                <form action="{{ route('admin.notifications.markAsUnread', $notification->id) }}" method="POST">
                                                    @csrf
